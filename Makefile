...
F4_TARGETS       = REVO REVO_OPBL SPARKY2 SPARKY2_OPBL REVONANO REVONANO_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON QUANTON_OPBL AQ32_V2 YOUPIF4 YOUPIF4_OPBL

F405_TARGETS     = REVO REVO_OPBL SPARKY2 SPARKY2_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON AQ32_V2 YOUPIF4 YOUPIF4_OPBL
...
OPBL_VALID_TARGETS = CC3D_OPBL REVO_OPBL REVONANO_OPBL SPARKY2_OPBL QUANTON_OPBL YOUPIF4_OPBL
...
ifeq ($(TARGET),$(filter $(TARGET), YOUPIF4_OPBL))
TARGET_FLAGS := $(TARGET_FLAGS) -DYOUPIF4
TARGET_DIR = $(ROOT)/src/main/target/YOUPIF4
TARGET_SRC = $(notdir $(wildcard $(TARGET_DIR)/*.c))
endif
